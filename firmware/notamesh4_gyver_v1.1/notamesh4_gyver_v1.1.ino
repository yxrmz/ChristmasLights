...
#define PIN_IR        4           // Номер пина, куда подключен датчик пульта,
...
#define CHIPSET       WS2811     //Тип микросхемы светодиодов в гирлянде (у нас WS2811)
//#define CHIPSET       WS2812B     //Тип микросхемы светодиодов в гирлянде (у нас WS2811)
